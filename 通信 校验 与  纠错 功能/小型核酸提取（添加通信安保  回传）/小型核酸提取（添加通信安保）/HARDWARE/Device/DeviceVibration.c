...
if(t0k&&t1k&&t2k&&t3k&&t4k&&t5k&&t6k&&t7k)
{
	  ...
	  while(i != 0)
		{
			i=0;
			if((abs(t0k - ad[7])>1)&&w0r)
				i++;
			if((abs(t4k - ad[4])>1)&&w1r)
				i++;
			if((abs(t1k - ad[5])>1)&&w2r)
				i++;
			if((abs(t5k - ad[6])>1)&&w3r)
				i++;
			if((abs(t2k - ad[3])>1)&&w4r)
				i++;
			if((abs(t6k - ad[0])>1)&&w5r)
				i++;
			if((abs(t3k - ad[1])>1)&&w6r)
				i++;
			if((abs(t7k - ad[2])>1)&&w7r)
				i++;		
		}
